...
for provincia in provincias_escaped:
    ...
    try:
        # Intenta recortar el raster de entrada según los límites de la provincia actual y guarda el resultado en el raster de salida
        ...
        if "ERROR 001566" in str(e):
            print(f"No se pudo recortar el raster para la provincia {provincia} debido a que está fuera de los límites del raster. Se omite.")
            continue
        else:
            raise
